...
modelsummary(
  ...
  output = here::here("Tabs", "robustness_models.html"),
  coef_map = c(
    "num_match_closed" = "Closed-Form Matches",
    "open_match_count" = "Open-Ended Matches",
    "num_unknown" = "Network Opacity"
...
modelsummary(
  ...
  stars = TRUE,
  exponentiate = TRUE,
  output = here::here("Tabs", "dislike_models.html"),
  coef_map = c(
