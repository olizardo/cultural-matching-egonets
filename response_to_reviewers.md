...
* **Location in Revised Manuscript:** Section 3.1 (Discrete-Time Event History Setup, Risk Set, and Tie Sequences), Section 3.3 (Analytical Strategy), Section 4.3 (Sensitivity Analyses), and Table 7 (Sensitivity Models: Absorbing First Dissolution and Ego Fixed-Effects).
...
* **Location in Revised Manuscript:** Section 3.1 (Discrete-Time Event History Setup, Risk Set, and Tie Sequences), Section 4.3 (Sensitivity Analyses), and Table 7 (Sensitivity Models: Absorbing First Dissolution and Ego Fixed-Effects).
