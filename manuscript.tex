...
\emph{Frequency of Interaction}: Measured with the prompt, ``How often do you communicate with this person?'' Responses were dichotomized into a \texttt{Daily} contact indicator versus a reference category of \texttt{Weekly} contact (given the high density of on-campus peer networks in this sample, almost all valid ties communicate at least weekly).
