...
To ensure the robustness of our core findings, we conduct a supplementary analysis substituting our mixed-effects modeling framework for an ego fixed-effects framework using conditional logistic regression. This adjusts for all unobserved, time-invariant ego-level characteristics.\footnote{For a full summary of descriptive statistics, see Tables \ref{tbl-descriptives-cont} and \ref{tbl-descriptives-cat} in the Appendix.}
...
To contextualize these coefficients, Figure \ref{fig-combined} plots the predicted probability of tie persistence across the observed ranges of each core theoretical variable. Across the board, cultural matching serves as a robust protective mechanism against tie decay (positive slopes), whereas cultural network opacity acts as a profound liability (steep negative slope).
